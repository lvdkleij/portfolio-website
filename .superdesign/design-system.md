...
Type (serif refinement approved 2026-08-31): Newsreader regular 400 ONLY for the name, upright rather than italic. Aim for 40–44px on desktop, 30–34px on phones, with optical sizing, line-height 1.05–1.12 and gently tight tracking around -0.025em. Preserve the narrow left column; avoid orphaned surname fragments and use a deliberate clean line break only where necessary. All menu, role, chat, panel and body text stays Inter, normal sentence case. Role 13px/1.5 regular and clearly subordinate to the name; nav 15–16px regular with minimum 44px interaction targets, visually grouped more closely; chat entry 13–14px medium, quieter than the menu; composer 14px desktop and at least 16px on phones to avoid input zoom; body 14–16px; labels 12–13px. No other serif use, all-caps labels, extra fonts, slogans or type ornament. Inter weights 400/500/600 only. Palette: text #292722, muted #62584c, paper #e8e6e1, panel #f1eade, borders #b9aa98, focus #6b482f. All colors may use opacity. Do not inherit old banking cobalt/violet/blue.
