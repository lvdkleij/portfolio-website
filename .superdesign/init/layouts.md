...
- Description: Full-height header, conversation workspace, optional context rail, and context reopening tab.
...
<template>
  <div class="studio-shell">
    ...
    <AppHeader :context-open="contextOpen" @new-chat="startNewChat" @toggle-context="contextOpen = !contextOpen" />
    <div class="studio-body">
      <ConversationWorkspace :key="conversationSession" @runtime-change="chatRuntime = $event" />
...
The shell uses `AppHeader.vue` as the shared top bar and `SystemContextRail.vue` as the shared right rail. The conversation page is the only product surface.
